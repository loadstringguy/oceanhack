...
function Ocean:NewWindow()
	...
	function Window:Tab(Title: string, ImageID: string)
		...
		local Tab = createInstance("ImageButton", {
			...
			BackgroundColor3 = Color3.fromRGB(119, 194, 237),
			BorderSizePixel = 0,
			ZIndex = 1
		})
		...
		local Path = createInstance("TextLabel", {
			...
			BackgroundTransparency = 1,
			Font = Enum.Font.SourceSans,
			Text = 'Ocean Hack / FF2 / <font color="#77c2ed">'..Title..'</font>',
			TextScaled = true,
			TextXAlignment = Enum.TextXAlignment.Left,
			TextYAlignment = Enum.TextYAlignment.Center,
			RichText = true,
		...
		function tab:Activate()
			...
			TS:Create(TabTitle, TweenInfo.new(0.1, Enum.EasingStyle.Quad), {TextColor3 = Color3.fromRGB(119, 194, 237)}):Play()
			TS:Create(Icon, TweenInfo.new(0.1, Enum.EasingStyle.Quad), {ImageColor3 = Color3.fromRGB(119, 194, 237)}):Play()
			Path.Visible = true
			Canvas.Visible = true
		end
		...
		function tab:Toggle(Title: string, Options: table)
			...
			local ToggleStroke_13 = createInstance("UIStroke", {
				Parent = Toggle,
				Color = Color3.fromRGB(119, 194, 237),
				Thickness = 1,
				Transparency = 0.5
			})
			...
			function Settings:Toggle(v)
				...
				if Settings.Value then
					...
					TS:Create(Knob_17, TweenInfo.new(0.1, Enum.EasingStyle.Sine), {BackgroundColor3 = Color3.fromRGB(119, 194, 237)}):Play()
...
task.spawn(function()
    ...
    AngleNum.TextColor3 = Color3.fromRGB(87, 123, 255)
    AngleNum.Text = "45"
    ...
    PowerNum.TextColor3 = Color3.fromRGB(87, 123, 255)
    PowerNum.Text = "60"
    ...
    TargetPlr.TextColor3 = Color3.fromRGB(87, 123, 255)
    ...
    ModeText.TextColor3 = Color3.fromRGB(87, 123, 255)
    ModeText.Text = "Dime"
    ...
    CatchText.TextColor3 = Color3.fromRGB(87, 123, 255)
    CatchText.Text = "Yes"
    ...
    IntText.TextColor3 = Color3.fromRGB(87, 123, 255)
    IntText.Text = "No"
    IntText.TextSize = 67
    ...
    airtimetext.TextColor3 = Color3.fromRGB(87, 123, 255)
    airtimetext.Text = "2s"
